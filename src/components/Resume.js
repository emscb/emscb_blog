...
const Resume = () => {
	return (
		<div>
			...
			<p>
				페이지는 React를 통해 그리고, 백엔드 서버는 Koa로 만들었습니다. 이전부터
				쌓아오던 RDB는 Python으로 크롤링하여 sqlite3로 쌓고 있습니다. 백엔드
				서버에서는 MongoDB를 이용한 DB에서 데이터를 가져와서 프론트엔드로
				넘겨줍니다. RDB와 MongoDB는 Python으로 크롤링 시 동기화됩니다.
			</p>
